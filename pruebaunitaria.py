...
class TestCocinero(unittest.TestCase):
    ...
    def test_DivisibleTempo(self):
        ...
        # prueba 2
        mc2 = MiClase(30, 210, 10, ["I'm Still standing Elton John", "Sirius Alan Parson", "Take on me a-ha"], [0.8, 0.9, 0.7])
    ...
    def test_ObtieneMasBailable(self):
        ...
        # prueba 2
        mc2 = MiClase(30, 210, 10, ["I'm Still standing Elton John", "Sirius Alan Parson", "Take on me a-ha"], [0.8, 0.9, 0.7])
        self.assertEqual(mc2.ObtieneMasBailable([0.9, 0.5, 0.4]), 0.9)
